...
exports.addDiary = exports.getEntries = exports.getEntriesWithoutSensitiveInfo = exports.findById = void 0;
const diarios_json_1 = __importDefault(require("./diarios.json"));
const diaries = diarios_json_1.default; // Asercion de datos, solo utilizar cuando sea necesario!
const findById = (id) => {
